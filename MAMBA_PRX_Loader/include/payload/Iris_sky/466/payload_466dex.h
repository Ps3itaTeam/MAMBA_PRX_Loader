#ifndef _PAYLOAD_466DEX_H
#define _PAYLOAD_466DEX_H
...
extern void set_bdvdemu_466dex(int current_payload);
extern void load_payload_466dex(int mode);
extern int is_payload_loaded_466dex(void);
